...
Purpose: Design observability for a distributed crawler fleet — fetch rate, frontier depth, error taxonomy, cost-per-URL, politeness adherence, and graceful shutdown/resume. Trawl emits monitoring specs; Builder wires metrics; Beacon owns SLO/SLI enforcement.
