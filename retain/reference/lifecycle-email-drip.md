...
- **Cloak / Comply (elsewhere)**: GDPR / CAN-SPAM / CASL / APPI compliance.
...
Coordinate with Cloak (privacy engineering) and Comply (regulatory audit) for regulated regions.
...
- Cloak / Comply: regulatory review for launched regions
...
- **Handoffs**: Prose, relay, Pulse, Experiment, Cloak/Comply, Scaffold.
