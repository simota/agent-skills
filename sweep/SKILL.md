...
- stale_flag_detection: Identify 100%-rollout flags older than 30 days using authoritative rollout/incidents and alias-aware code evidence; propose one-flag removal changes with configured tooling
