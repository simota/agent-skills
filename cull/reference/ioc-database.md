...
Cull's `propagation` recipe specifically targets this maintainer-side pattern.
...
8. Update the `Critical Patterns (Quick Reference)` table in `cull/SKILL.md` if the family introduces a new persistence surface or retaliation hook.
