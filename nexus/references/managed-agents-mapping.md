...
| **Outcomes** | Rubric-based automatic output evaluation and iterative improvement. Each spec defines what "done" looks like; the platform scores against it and loops until the rubric passes. | Evaluator-Loop pattern; Sprint Contract; Rubric System; Judge as quality gate. | `references/evaluator-loop-protocol.md` (merged: loop + contract + rubric) |
