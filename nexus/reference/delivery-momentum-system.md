...
Purpose: Read this file when Nexus[deliver] must prove forward progress, score cycle output, validate velocity, or decide whether Rally is justified.
...
Velocity tracking and forward progress guarantee for Nexus[deliver].
...
When Rally is active, assign explicit file ownership per team. No two teams write to the same file. Shared dependencies resolved before launch. Integration managed by Nexus[deliver] after Rally completion.
