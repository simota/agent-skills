...
Purpose: Read this file when Nexus[deliver] must classify a decision, score cumulative risk, choose whether to consult Magi, or record a decision log entry.
...
Risk-based autonomous decision framework for Nexus[deliver].
