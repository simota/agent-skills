...
| **agy fallback** | Verified native/headless interface via `_common/CLI_COMPATIBILITY.md` §9.2 | Authorized supported model and result channel; preserve independent generator/critic roles | Only an explicitly allowed fallback meeting task capabilities |
