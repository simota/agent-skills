...
- **Any chain step authoring a doc** (Scribe/Accord/Quill/Tome/Morph) — the spawn prompt carries the W1 reader contract, the W4–W5 grounding duty, and the **W11b no-padding calibration** in its output envelope; the hub runs W12 at VERIFY.
