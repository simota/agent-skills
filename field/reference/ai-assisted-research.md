...
Purpose: Define where AI helps research, where it does not, and how to use synthetic users safely.
Contents: current adoption signals, AI role split, synthetic-user guardrails, decision flow, risk checklist.
