...
- **Field `survey`**: Exploratory / research-purpose survey design (Likert, MaxDiff, Conjoint, semantic differential). Instrument authoring, sample-size math, order-bias control, reliability checks.
