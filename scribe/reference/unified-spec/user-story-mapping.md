...
HANDOFF     →  to Scribe L1: tasks become REQ-*
...
For Scribe handoff, capture as Markdown table (backbone cols, task rows, slice annotations) — durable and diff-friendly.
...
### Handoffs
- Scribe L1 `requirements`: promote tasks to REQ-*
...
- **Handoffs**: Scribe L1, Sherpa, Rank, Canvas, Scribe.
