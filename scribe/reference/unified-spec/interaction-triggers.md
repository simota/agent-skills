...
Purpose: Use this file when Scribe must pause and serialize an ask-first decision as a YAML trigger.
...
INTERACTION_TRIGGER:
  ...
  question: "The complexity signals are mixed. Which scope should Scribe use?"
  options:
...
INTERACTION_TRIGGER:
  ...
  question: "The scope is large. Should Scribe ask Sherpa to decompose it first?"
  options:
...
INTERACTION_TRIGGER:
  ...
  question: "Architecture judgment is required. How should Scribe proceed?"
  options:
...
INTERACTION_TRIGGER:
  ...
  question: "Scribe can define flows and design requirements, but not visual deliverables. Should visual work be delegated?"
  options:
    - "Keep flow and requirements in Scribe, delegate visuals to Vision or Palette (Recommended)"
  ...
  default: "Keep flow and requirements in Scribe, delegate visuals to Vision or Palette"
```
