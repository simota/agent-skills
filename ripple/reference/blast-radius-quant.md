...
Route compliance-impacting changes to Cloak and Canon[regulatory] for parallel review.
...
- **Handoffs**: Cloak ([reason]), Canon[regulatory] ([reason])
...
- [ ] Cloak / Canon[regulatory] (compliance overlay)
...
- **Handoff targets**: Beacon (SLO), Triage (SEV1/2 brief), Sentinel (security), Cloak/Canon[regulatory] (data class), Launch (rollout gating).
