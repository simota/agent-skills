...
This file does **not** duplicate `bolt/reference/kotlin-cheatsheet.md` §13 (JVM/Kotlin-language-level Compose bytecode notes, Flow perf, build performance) or `bolt/reference/kotlin-best-practices.md` (general Kotlin idioms). Read it alongside:
