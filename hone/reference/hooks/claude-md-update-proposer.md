...
| The rule is reversible by a hook | Author the hook instead (Hone). |
...
Pair this recipe with the SessionStart recipe (`reference/hooks/sessionstart-hook.md`) for a full open/close lifecycle: SessionStart loads context, Stop proposes durable updates from what was learned.
