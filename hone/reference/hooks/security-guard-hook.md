...
DENYLIST="${HONE_BLOCKED_MCP_TOOLS:-}"
...
Usage:
```bash
export HONE_BLOCKED_MCP_TOOLS="mcp__shell__exec,mcp__notion__delete_page"
```
...
- Knight Capital 2012 incident (flag reuse) — referenced by Sweep / Hone
