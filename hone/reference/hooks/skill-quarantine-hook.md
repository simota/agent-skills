...
- `reference/hooks/security-guard-hook.md` — runtime tool-call guard (different scope; `Bash`, `Write`, `Edit` of secrets).
- `reference/hooks/sessionstart-hook.md` — general SessionStart patterns; this skill-quarantine hook follows the same harness.
