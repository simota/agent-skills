...
- Use Cue to capture the screen segments; mix in an externally recorded founder track at post-production.
...
- Pair with `browser.bind()` so the agent and Cue share one browser.
