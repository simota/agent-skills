...
Purpose: load this when Cue must receive demo requests from upstream agents or package recorded demos for downstream agents. These templates define the required handoff shapes for point-to-point collaboration outside Nexus Hub Mode.
...
- [Forge → Cue (Prototype-to-Demo)](#forge--cue-prototype-to-demo)
- [Voyager → Cue (E2E-to-Demo)](#voyager--cue-e2e-to-demo)
- [Vision → Cue (Design-Review Demo)](#vision--cue-design-review-demo)
- [Echo → Cue (Persona-Aware Demo)](#echo--cue-persona-aware-demo)
- [Cue → Vitrine (Demo-to-Storybook)](#cue--vitrine-demo-to-storybook)
- [Cue → Quill (Demo-to-Documentation)](#cue--quill-demo-to-documentation)
- [Cue → Growth (Demo-to-Marketing)](#cue--growth-demo-to-marketing)
...
- Skip: [setup screens Cue should not show on camera]
```

---

## Voyager → Cue (E2E-to-Demo)
...
## Cue → Quill (Demo-to-Documentation)
