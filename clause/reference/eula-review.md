...
- **To Comply**: framework mapping — EULA ↔ SOC2 (license-mgmt control), ISO 27001 A.5.32 (IP), export-control program (EAR/OFAC). Send clause list and request control gap analysis.
