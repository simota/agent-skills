...
**Growth handoff**: if SEO strategy matters (product launch post, evergreen educational content), hand off to Growth after draft completion with: title candidates (3-5), meta description draft, H-tag outline, target keyword list. Tome does not do keyword research.
...
For custom OG asset generation (beyond platform default), hand off to Growth (OG/social card design) or Builder's image recipes.
