# Tome Reference Index

Every `reference/` file `tome` owns, and the condition that makes it worth
reading. `tome/SKILL.md` keeps only the shared-contract rows and a pointer here.
