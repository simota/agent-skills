...
Purpose: Use this reference when Launch must turn Markdown or HTML reports into stable PDF output without changing the report content.
...
| `styles/report-style.css` | Report styling for PDF-friendly layout |
...
```bash
md-to-pdf client-report-YYYY-MM-DD.md --stylesheet styles/report-style.css
```
