...
Purpose: Use this mode when Launch should turn PR and release data into a human, developer-friendly narrative without changing the underlying facts.
...
Selection guidance: per agile-coach surveys for 2025, Keep/Drop/Start, Mad/Sad/Glad, and Speed Boat remain the most-cited defaults (`kollabe.com/posts/retrospective-formats-compared`, retroteam.ai 2025). When narrative voice is layered onto Launch data, pick the framework that matches what the PR record actually shows: a heavy-refactor week pairs with Sailboat (rocks), a launch week pairs with Plus/Delta, and a high-defect-rate week pairs with Mad/Sad/Glad.
