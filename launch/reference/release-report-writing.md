...
Purpose: Use this reference when Launch must produce release notes or changelog entries that are readable, category-accurate, and audience-fit.
...
Launch produces the changelog content; the actual `bump+publish` step belongs to Launch (release execution). When recommending a tool, capture commit-style adherence, monorepo posture, and whether the team prefers automation or PR-based human review.
