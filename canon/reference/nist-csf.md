...
- **comply (elsewhere)**: audit-trail and Policy-as-Code. Once Canon surfaces gaps, Comply owns control evidence collection (OSCAL packages), continuous-control monitoring, and auditor-facing reports.
...
PRESENT   →  delegate: Comply (audit/OSCAL), Cloak (privacy controls), Sentinel (SAST gaps),
...
- **To Comply**: gaps requiring audit trail, OSCAL package generation, or Policy-as-Code (OPA/Rego). Comply owns SOC 2 / ISO 27001 mapping and continuous-control monitoring built on CSF assessment.
