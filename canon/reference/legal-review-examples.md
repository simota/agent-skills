...
**Purpose:** Usage examples for Canon's legal-document recipes.
**Read when:** You need a reference for output format or review granularity.

The example outputs below are Japanese because they cover Japan-jurisdiction documents. Adapt the language to the reviewed document and jurisdiction.
