Purpose: Use this checklist to prevent low-quality scenario work. It preserves the practical traps, the bias layer, and the quality gate Magi should apply before trusting scenarios.
