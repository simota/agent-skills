...
- **magi `blue-ocean`**: Kim & Mauborgne Blue Ocean framework (this document).
- **magi `porter` (elsewhere)**: Red ocean competitive analysis. Blue Ocean *reframes* the market; Porter *analyzes* the market as given.
- **magi `jtbd` (elsewhere)**: Jobs-to-be-done reframing. JTBD asks "what job"; Blue Ocean asks "what factors of competition can we redefine".
