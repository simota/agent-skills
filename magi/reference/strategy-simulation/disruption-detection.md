# Disruption Detection Reference — Magi

Purpose: Use this file when Magi must evaluate disruption risk, position a business on the industry lifecycle, or assess technology adoption trajectories.
...
- Escalate to Magi (`MAGI_SIMULATE_TO_DECIDE`) if disruption risk ≥ 4.0 for Go/No-Go evaluation
