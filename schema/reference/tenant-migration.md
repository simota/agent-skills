...
- **Schema `tenant mode=migration`**: tenant-level data moves and isolation-level transitions inside an established multi-tenant model. Output is a migration plan with cutover mode, verification, and rollback.
