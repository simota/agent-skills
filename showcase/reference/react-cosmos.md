...
- **To Showcase `story` (peer)**: when Cosmos limits become decisive (need MCP, MDX, Chromatic, multi-framework), migrate fixtures to CSF — many fixtures map 1:1 to CSF stories.
