...
| Interview transcripts | Researcher | High | Research cycle completed |
...
2. **Match**: Compare synthetic demands against real data from Voice/Trace/Researcher
...
- **Acceptable**: 40-59% match rate — increase Researcher/Voice input
