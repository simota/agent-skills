...
**Purpose:** Canonical handoff blocks between Husk and partner agents.
**Read when:** Producing inbound / outbound handoff sections in a Husk report.

All handoffs follow `_common/HANDOFF.md` canonical schema. The fields below are the Husk-specific surfaces.
...
recommended_first_actions:
  ...
  - "Wait for Husk eradication-verified before any credential rotation"
...
context:
  ...
  proposed_metapattern:
    ...
    affected_agents: [Sentinel, Chain, Vigil, Husk]
ask:
