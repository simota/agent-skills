...
|------|-----------|------------|
| **Confidence cap** | AI-only generation capped at confidence ≤ 0.50 | Cast (generation), Echo (usage), Echo[demand] (usage) |
...
|---------|-------------|------------|
| All synthetic-derived findings | `[synthetic-hypothesis]` | Echo (reports), Echo[demand] (demand reports) |
...
| **Demand forecasting** | Synthetic demands require real-data calibration (see `echo/reference/demand-calibration.md`) |
...
Echo[demand] demand calibration      → Cast FUSE   (coverage gap signal)
