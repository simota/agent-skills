...
|------|-------------|-----------|-----|
| Default / balanced | **`claude-sonnet-5`** (Sonnet 5) ¶ | `gpt-5.6-terra` † | **Gemini 3.6 Flash (High)** ‡ |
| High-reasoning / precision | `opus` (claude-opus-5) / `fable-5` (Fable 5 hub — see ¶) | `gpt-5.6-sol` † (flagship; released 2026-07-09) | **Gemini 3.6 Flash (High)** ‡ |
| Fast / cheap | `haiku` (claude-haiku-4-5) | `gpt-5.6-luna` † | **Gemini 3.6 Flash (High)** ‡ |
...
- ~~agy "Deep Think" CLI flag~~ **MOOT under the §4 ‡ model mandate** — this harness never uses agy's Deep Think (Gemini 3.6 Flash (High) is forced for every agy invocation); no need to verify the flag. (Deep Think remains Ultra-tier / staged-rollout per 2026-06 research; out of scope here.)
