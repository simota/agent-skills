...
The super-quality bar for Design, Animation, and Branding axes. These are the standards `bazaar` enforces upstream of and across Stages 4–7. Lighthouse and WCAG are the floor — this document defines the ceiling.
...
Prose owns voice execution. `bazaar` confirms the brand system is referenced.
