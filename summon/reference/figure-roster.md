...
**Read when:** You are in GROUND, or running the `roster` recipe to author/refresh a profile.

## Storage

- Profiles: `.agents/summon/roster/{figure-slug}.md` (e.g. `richard-feynman.md`)
