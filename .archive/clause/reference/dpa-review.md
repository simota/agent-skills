...
- **To Canon[regulatory]**: regulatory mapping — DPA ↔ SOC2 CC9.1 (vendor mgmt), ISO 27001 A.5.19-A.5.22 (supplier relationships), HIPAA BAA equivalence. Send DPA control list and request gap analysis vs target framework.
