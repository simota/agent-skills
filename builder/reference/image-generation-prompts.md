...
Purpose: Read this when Builder needs canonical prompt architecture, prompt-quality thresholds, JP -> EN translation rules, policy-safe rewriting, or `v1.50+` prompt controls.
