...
| 7.6 | Macro plugin failed to load → silent build failure or red squiggles                | Macros need a plugin executable; if the plugin can't be built or trust isn't granted, you may see vague errors. | Inspect Issue Navigator carefully; rerun Xcode > Settings > Locations > "Manage Macros".     | —                                      |
