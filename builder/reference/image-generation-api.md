...
Purpose: Read this when Builder needs canonical Gemini API integration rules, compatibility notes, error handling, rate guidance, or SynthID handling details.
