...
HANDOFF      →  Builder: middleware
             ...
             →  Canon[regulatory]: regulated context (PCI / HIPAA implications)
```
...
- Canon[regulatory]: regulated mapping
```
...
- **Handoffs**: Builder, Crypt, Sentinel, Probe, Vigil, Canon[regulatory].
