...
| `_common/CODE_QUALITY.md` | You are preparing implementation requirements or reviewing returned implementation evidence; the receiving code-writing agent emits `CODE_QUALITY_GATE`. |
