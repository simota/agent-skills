...
**Rationale:** Anthropic guidance is "Keep SKILL.md body under 500 lines for optimal performance" but the existing corpus runs higher (103 skills as of 2026-08-19). Generation-3 audit tiers the thresholds so P0/P1 fire only on truly egregious sizes; refactor work is queued at P2/P3. As skills migrate detail to `reference/`, raise the floors over time.
