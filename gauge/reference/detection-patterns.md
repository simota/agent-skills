...
**Rationale:** Anthropic explicit guidance: "Keep SKILL.md body under 500 lines for optimal performance". Tiering exists because the existing corpus runs higher (125 skills as of 2026-08-18); FAIL only fires on truly oversized files so CI doesn't choke on legacy violations.
