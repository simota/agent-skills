# Compete Reference Index

Every `reference/` file `compete` owns, and the condition that makes it worth
reading. `compete/SKILL.md` keeps only the shared-contract rows and a pointer here.
