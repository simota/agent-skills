...
Sentinel `authn` then validates the implementation matches this design; Canon[regulatory] confirms the parameters meet the applicable standard (NIST SP 800-63B AAL levels, PCI-DSS 4.0 §8.3.6).
