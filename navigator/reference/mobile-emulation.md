...
Reference for Navigator's `mobile` recipe. Covers device descriptors, viewport / UA / touch / geolocation / timezone configuration, network throttling, iOS Safari / Android Chrome divergence, and validation patterns.
