...
SPIDER_TO_BUILDER_HANDOFF:
  ...
  Reference_Files:
    - "spider/reference/distributed-architecture.md — topology patterns"
    - "spider/reference/frontier-design.md — dedup implementation"
    - "spider/reference/compliance-architecture.md — legal subsystem"
    - "spider/reference/anti-detection-architecture.md — detection avoidance"
    - "spider/reference/link-graph.md — link graph design"
    - "spider/reference/observability.md — monitoring and SLO"
  Constraints:
