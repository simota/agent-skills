...
Purpose: Design a multi-layer deduplication system for a web-scale crawler — URL canonicalization, exact-URL dedup (probabilistic or exact), content-hash dedup, and near-duplicate clustering. Spider emits the strategy; Builder implements; Stream consumes clean records.
