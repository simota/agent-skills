...
**Purpose:** Input / output handoff templates for the Dock agent.
...
DOCK_TO_WIELD_HANDOFF:
  ...
  notes: "Dictionary covers document CRUD and selection; Wield owns end-user automation scripts against this surface"
```

### DOCK_TO_CLOAK_HANDOFF
