...
`jtbd` must not stop at an abstract job map — bridge it to Echo[demand]'s standard tagged-demand output so Spark/Scribe[unified] receive actionable artifacts. Each Job-Map stage friction becomes a demand:
