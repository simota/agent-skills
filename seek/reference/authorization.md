...
PII classification, consent, and retention stay with `Cloak`. Regulatory control mapping stays with `Oath`.
...
obligations → `Cloak`. Control mapping and audit evidence → `Oath`. Adversarial validation of the
