...
**Purpose:** Session patterns and mode transition reference for Riff.
...
- Riff judges: 3+ directions have emerged

### EVALUATE → PROPOSE

- User: "I want to go this direction"
- User: "How do we make it concrete?"
- Riff judges: 1-2 directions have been selected

### PROPOSE → SUBTRACT

- User: "Maybe I'm packing too much in"
- User: "Can we simplify?"
- Riff judges: Concrete plan has 3+ elements

### Any → EXPAND

- User: "I'm stuck"
- User: "Any other perspectives?"
- Riff judges: 2+ turns circling the same point
